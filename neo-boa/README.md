...
```
### Pip를 이용한 Neo3-boa 설치 
```sh
$ pip install neo3-boa
```
### Neo3-boa 커맨드 검증
터미널에서 neo3-boa 명령어를 실행 한다.
```sh
$ neo3-boa -v
```
## 개발 코드 추가
...
```sh
$ mkdir example
$ touch example/nep17.py
```
### nep17.py 코드 작성
아래 코드를 `nep17.py` 파일에 복사한다.
```python
...
def manifest_metadata() -> NeoMetadata:
    ...
    meta.author = "WHORU. Ludium"
    meta.description = "NEP-17(LUDIUM) neo-boa Example"
    meta.email = "junho9341@gmail.com"
    return meta
